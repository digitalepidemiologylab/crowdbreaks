    ...
    def index
      ...
      respond_to do |format|
        format.html {
          ...
          if @local_batch_job.assoc_s3_key_exists?(type, @local_batch_job.local_tweets)
        ...
        format.csv { 
          redirect_to @local_batch_job.assoc_signed_file_path(type, @local_batch_job.local_tweets)
        }
        format.js {
