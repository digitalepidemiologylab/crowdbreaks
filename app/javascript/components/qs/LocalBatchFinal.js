...
export const LocalBatchTweetNotAvailable = (props) => {
  return (
    <div>
      <div className="row justify-content-center">
        <div className="col-12 col-sm-10 col-lg-6 text-center">
          <h1 className="mb-4">Tweet is not available anymore.</h1>
          <p className='large text-light mb-4'>Tweet Id: {props.tweetId}</p>
        </div>
      </div>
